    ...
    <header className="w-full bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg shadow-sm p-4 flex justify-between items-center transition-colors z-40 relative">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          ...
          >
            ...
            {unreadMessagesCount > 0 && (
              <span className="absolute top-0 right-0 block h-3 w-3 rounded-full ring-2 ring-[#030014] bg-red-500"></span>
            )}
          </button>
        </div>
        ...
        <div className="relative">
          ...
          >
            <div className="w-8 h-8 rounded-full bg-modern-primary flex items-center justify-center text-white text-sm font-semibold">
